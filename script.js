const WORDS = [
  ...
  'YOUTH', 'ZEBRA', 'ZONES'
  // '.filter' below drops any accidental non-5-letter entries (e.g. DESERT, EITHER, GAIN, PLUNGE)
  // so a typo in this list can never break the board by becoming an invalid solution word.
].filter((w) => w.length === 5);
...
function updateBoard() {
  ...
  // Render the guess currently being typed
